  ...
  return (
    <div className="relative min-h-screen flex flex-col p-6 overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto space-y-6 z-10">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 sm:gap-0">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-cyan-100 text-xs sm:text-sm">Student Portal</p>
              </div>
            </div>
        ...
        {/* Enhanced Dashboard Label */}
        <div className="bg-gradient-to-r from-green-400 to-emerald-500 text-white p-4 sm:p-6 rounded-2xl shadow-lg backdrop-blur-sm border border-white/20">
          <div className="flex items-center space-x-4">
            <div className="p-2 sm:p-3 bg-white/20 rounded-xl backdrop-blur-sm">
              <Users className="w-6 h-6 sm:w-8 sm:h-8" />
            </div>
            <div>
              <h2 className="text-xl sm:text-2xl font-bold">Student Dashboard</h2>
              <p className="text-green-100 text-xs sm:text-sm">Access your academic information</p>
            </div>
          </div>
        </div>

        {/* Enhanced Dashboard Tiles Grid */}
